...
echo "cd /d %steam:~0,2%\mindustry-client&&git fetch>gitStatus&&set /p git=<gitStatus&del gitStatus&&if defined git (cd /D %steam:~0,2%\mindustry-client&&git pull&&call gradlew.bat desktop:dist --no-daemon)">>launcher.bat
