...
public class Jval2{
    ...
    public static final Jval2 TRUE = new Jval2(true);
    public static final Jval2 FALSE = new Jval2(false);
    public static final Jval2 NULL = new Jval2(null);
    ...
    public static Jval2 newObject(){
        return new Jval2(new JsonMap());
    }

    public static Jval2 newArray(){
        return new Jval2(new JsonArray());
    }
     ...
     */
    public static Jval2 read(Reader reader){
        try{
    ...
    public static Jval2 read(byte[] bytes){
        try{
     ...
     * @return the Hjson value that has been read
     */
    public static Jval2 read(String text){
        try{
    ...
    public static Jval2 valueOf(int value){ return new Jval2(value); }
    public static Jval2 valueOf(long value){ return new Jval2(value); }
    public static Jval2 valueOf(float value){ return new Jval2(value); }
    public static Jval2 valueOf(double value){ return new Jval2(value); }
    public static Jval2 valueOf(String string){ return string == null ? NULL : new Jval2(string); }
    public static Jval2 valueOf(boolean value){ return value ? TRUE : FALSE; }
    ...
    public Jval2 get(String name){
        if(name == null) throw new NullPointerException("name is null");
        return asObject().get(name);
    }

    public void add(String name, Jval2 val){
        if(name == null) throw new NullPointerException("name is null");
    ...
    public Jval2 add(Jval2 value){
        asArray().add(value);
        return this;
    }

    public Jval2 add(String value){
        asArray().add(new Jval2(value));
        return this;
    }

    public Jval2 add(Number value){
        asArray().add(new Jval2(value));
        return this;
    }

    public Jval2 add(boolean value){
        asArray().add(new Jval2(value));
        return this;
    }

    public Jval2 put(String name, Jval2 val){
        if(val != null) add(name, val);
        return this;
    }

    public Jval2 put(String name, String val){
        if(val != null) add(name, val);
        return this;
    }

    public Jval2 put(String name, Number val){
        if(val != null) add(name, new Jval2(val));
        return this;
    }

    public Jval2 put(String name, boolean val){
        add(name, new Jval2(val));
        return this;
    }

    public Jval2 remove(String name){
        if(name == null) throw new NullPointerException("name is null");
    ...
    public boolean equals(Object object){
        return object != null && object.getClass() == getClass() &&
            ((value == null && ((Jval2)object).value == null)
                || (((Jval2)object).value != null && value != null && value.equals(((Jval2)object).value)));
    }

    /** Alias class of whatever is used to store json maps (objects). */
    public static class JsonMap extends ArrayMap<String, Jval2>{

    }

    /** Alias class of json arrays. */
    public static class JsonArray extends Seq<Jval2>{
    ...
    static class Hparser{
        ...
        Jval2 parse() throws IOException{
        ...
        Jval2 checkTrailing(Jval2 v) throws JsonParseException, IOException{
            skipWhiteSpace();
            if(!isEndOfText()) throw error("Extra characters in input: " + current);
            return v;
        }

        private Jval2 readValue() throws IOException{
            switch(current){
                case '\'':
                case '"':
                    return readString();
        ...
        private Jval2 readTfnns() throws IOException{
                    ...
                    switch(first){
                        ...
                        default:
                            if(first == '-' || first >= '0' && first <= '9'){
                                Jval2 n = tryParseNumber(value, false);
                                if(n != null) return n;
                            }
                    }
                    if(isEol){
                        ...
                        return new Jval2(value.toString().trim());
                    }
                }
                value.append((char)current);
            }
        ...
        private Jval2 readArray() throws IOException{
            isArray = true;
            read();
            JsonArray array = new JsonArray();
            skipWhiteSpace();
            if(readIf(']')){
                return new Jval2(array);
            }
            while(true){
                skipWhiteSpace();
                array.add(readValue());
        ...
        private Jval2 readObject(boolean objectWithoutBraces) throws IOException{
        ...
        private Jval2 readString() throws IOException{
            return new Jval2(readStringInternal(true));
        }
        ...
        static Jval2 tryParseNumber(StringBuilder value, boolean stopAtNext){
            ...
            if(!str.contains(".") && !str.contains(",") && !str.contains("e")){
                try{
                    return new Jval2(Long.parseLong(str));
                }catch(NumberFormatException ignored){
                }
            }

            return new Jval2(Double.parseDouble(str));
        }

        static Jval2 tryParseNumber(String value) throws IOException{
    ...
    static class Hwriter{
        ...
        public void save(Jval2 value, Writer tw, int level, String separator, boolean noIndent) throws IOException{
            if(value == null){
                tw.write(separator);
                tw.write("null");
                return;
            ...
            switch(value.getType()){
                case object:
                    ...
                    for(ObjectMap.Entry<String, Jval2> pair : obj){
    ...
    static class Jwriter{
        ...
        public void save(Jval2 value, Writer tw, int level) throws IOException{
