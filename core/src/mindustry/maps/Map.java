...
public class Map implements Comparable<Map>, Publishable{
    ...
    public int getHightScore(){
        return Core.settings.getInt("hiscore" + file.nameWithoutExtension() + (hasSteamID() ? getSteamID() : ""), 0);
    }
    ...
    public void setHighScore(int score){
        Core.settings.put("hiscore" + file.nameWithoutExtension() + (hasSteamID() ? getSteamID() : ""), score);
    }
