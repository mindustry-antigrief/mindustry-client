...
public class ParticleWeather extends Weather{
    ...
    public void drawOver(WeatherState state, float alpha){
        ...
        if(drawParticles){
            drawParticles(region, color, sizeMin, sizeMax, density, state.intensity, state.opacity * alpha, windx, windy, minAlpha, maxAlpha, sinSclMin, sinSclMax, sinMagMin, sinMagMax, randomParticleRotation);
        }
    }
}
