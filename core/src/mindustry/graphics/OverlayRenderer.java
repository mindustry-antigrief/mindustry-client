...
//        input.drawBottom();
    ...
    public void drawTop(){
        ...
        if(ui.hudfrag.blockfrag.hover() instanceof Unit unit && unit.controller() instanceof LogicAI ai && ai.controller != null && ai.controller.isValid() && (state.isEditor() || !ai.controller.block.privileged) && !hidingUnits && !(hidingAirUnits && unit.isFlying())){
