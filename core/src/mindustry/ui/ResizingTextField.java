 ...
 * @author Nathan Sweet
 */
public class ResizingTextField extends Element implements Disableable{
    ...
    public void next(boolean up){
        ...
        ResizingTextField current = this;
        while(true){
            current.getParent().localToStageCoordinates(tmp1.set(getX(), getY()));
            ResizingTextField textField = current.findNextTextField(stage.getElements(), null, tmp2, tmp1, up);
    ...
    private ResizingTextField findNextTextField(Array<Element> elements, ResizingTextField best, Vec2 bestCoords, Vec2 currentCoords,
                                                boolean up){
        for(int i = 0, n = elements.size; i < n; i++){
            Element element = elements.get(i);
            if(element == this) continue;
            if(element instanceof ResizingTextField){
                ResizingTextField textField = (ResizingTextField)element;
                ...
                if((elementCoords.y < currentCoords.y || (elementCoords.y == currentCoords.y && elementCoords.x > currentCoords.x)) ^ up){
                    ...
                    || (elementCoords.y > bestCoords.y || (elementCoords.y == bestCoords.y && elementCoords.x < bestCoords.x)) ^ up){
                        best = (ResizingTextField)element;
    ...
    public interface TextFieldListener{
        void keyTyped(ResizingTextField textField, char c);
    }
    ...
    public interface TextFieldFilter{
        ...
        boolean acceptChar(ResizingTextField textField, char c);
    }
    ...
    /**
     * The default {@link OnscreenKeyboard} used by all {@link ResizingTextField} instances. Just uses
    ...
    public class TextFieldClickListener extends ClickListener{
        ...
        public boolean touchDown(InputEvent event, float x, float y, int pointer, KeyCode button){
            ...
            Scene stage = getScene();
            if(stage != null) stage.setKeyboardFocus(ResizingTextField.this);
            keyboard.show(true);
            hasSelection = true;
            return true;
        }
        ...
        public boolean keyDown(InputEvent event, KeyCode keycode){
            ...
            Scene stage = getScene();
            if(stage == null || stage.getKeyboardFocus() != ResizingTextField.this) return false;
        ...
        public boolean keyTyped(InputEvent event, char character){
            ...
            if((character == TAB) && focusTraversal){
                ...
                if(add || remove){
                    ...
                    if(add && !remove){
                        ...
                        if(filter != null && !filter.acceptChar(ResizingTextField.this, character)) return true;
            ...
            if(listener != null) listener.keyTyped(ResizingTextField.this, character);
            return true;
        }
    }
}
