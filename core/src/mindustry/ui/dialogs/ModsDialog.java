...
public class ModsDialog extends BaseDialog{
    ...
    public ModsDialog(){
        ...
        buttons.button("@mods.updateactive", Icon.download, () -> mods.mods.each(m -> m.state == ModState.enabled && m.getRepo() != null, m -> githubImportMod(m.getRepo(), m.isJava(), null, null)));
