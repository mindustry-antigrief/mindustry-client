    ...
    public static class JumpCurve extends Element{
        ...
        public void drawCurve(float x, float y, float x2, float y2){
            ...
            if(draw1curve){
                ...
                Lines.swirl(maxX - curveRadius, y + curveRadius * curveDirection, curveRadius, 1/4f, isUpwards * -90);
            }
            Lines.line(maxX, yNew + curveRadius * curveDirection, maxX, y2New - curveRadius * curveDirection);
            if(draw2curve){
                Lines.swirl(maxX - curveRadius, y2 - curveRadius * curveDirection, curveRadius, 1/4f, (isUpwards - 1) * 90);
