...
public class Mods implements Loadable{
        ...
        for(Fi file : sprites){
            ...
            mainExecutor.execute(() -> {
                try{
                    ...
                    queues[page.ordinal()].offer(new Pair<>(fullName, pix)); //add the pixmap to the page queue. each page's queue is packed in parallel
    ...
    public static class LoadedMod implements Publishable, Disposable{
        ...
        public boolean isBlacklisted(){
            return (blacklistedMods.contains(name) || blacklistedMods.contains(name + ":" + meta.version)) && !OS.hasProp(Strings.format("allow-@", name));
        }
