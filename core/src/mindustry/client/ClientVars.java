...
public class ClientVars {
    ...
    // Hotkeys
    public static boolean showingEnemyTurrets, showingAllyTurrets, hidingUnits, hidingAirUnits, hidingBlocks, hidingPlans, dispatchingBuildPlans, showingOverdrives, showingInvTurrets;
